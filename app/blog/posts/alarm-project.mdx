...
To tackle this issue, the project proposes an innovative alarm clock integrated into a wooden coaster.
In the morning, when the alarm starts ringing, the user must lift the glass from the base to silence it.
A sensor inside the base detects the movement and turns off the alarm. This interaction encourages the user
to drink water as part of their morning routine, promoting healthy hydration habits from the very start of the day.

<div className='flex justify-center my-10 '>

<Image src="/images/alarm.png" alt="alarm picture" width={1000} height={500} />
...
The project includes simple interactions between the user and the device:
